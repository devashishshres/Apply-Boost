...
export function UploadSection() {
  ...
  // Listen for reset event from results section
  useEffect(() => {
    const handleReset = () => {
      setResumeFile(null);
      setJobDescription("");
    ...
    window.addEventListener("resetApplication", handleReset);

    return () => {
      window.removeEventListener("resetApplication", handleReset);
    };
  }, []);
