        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-card-foreground text-balance max-w-lg">
              Transform any job application into a winning strategy. Upload your resume, paste the job description, and
              let AI craft your perfect application materials.
            </p>
          ...
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-card p-6 rounded-2xl border border-border hover:border-primary/30 transition-all duration-300 float-animation">
                ...
                <p className="text-sm text-muted-foreground">Get all materials in under 30 seconds</p>
              </div>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">Perfectly matched to each job</p>
              </div>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground">
                  Advanced language models analyze job requirements and optimize your application materials for maximum
                  impact.
                </p>
              </div>
            </div>
